                                ...
                                <div class="col-lg-12 col-md-12">
                                    <select class="select2 form-select" id="redirectDropdown" onchange="redirectPage(this)" required>
                                        ...
                                        @foreach ($employees as $employee)
                                            <option data-user-slug="{{ $employee->slug }}" value="{{ URL::to('user_leaves/report/'.$employee->slug) }}" {{ $user->slug==$employee->slug?"selected":"" }}>{{ $employee->first_name }} {{ $employee->last_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
