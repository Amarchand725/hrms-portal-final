                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                                <select class="select2 form-select" id="redirectDropdown" onchange="redirectPage(this)">
                                    <option value="{{ route('employee.attendance.daily-log') }}" selected>Select employee</option>
                                    @foreach ($employees as $employee)
                                        <option data-user-slug="{{ $employee->slug }}" value="{{ URL::to('employee/attendance/daily-log/'.$month.'/'.$year.'/'.$employee->slug) }}" {{ $user->slug==$employee->slug?'selected':'' }}>{{ $employee->first_name }} {{ $employee->last_name }}</option>
                                    @endforeach
                            </select>
                        </div>
                    </div>
