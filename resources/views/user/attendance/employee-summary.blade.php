                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <select class="select2 form-select" id="redirectDropdown" onchange="redirectPage(this)">
                                        <option value="{{ URL::to('employee/attendance/summary') }}" selected>Select employee</option>
                                        @foreach ($employees as $employee)
                                            <option value="{{ URL::to('employee/attendance/summary/'.$month.'/'.$year.'/'.$employee->slug) }}" {{ $user->slug==$employee->slug?'selected':'' }}>{{ $employee->first_name }} {{ $employee->last_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
