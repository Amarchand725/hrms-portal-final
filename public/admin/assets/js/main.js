...
if (typeof $ !== 'undefined') {
    $(function() {
        ...
        var searchToggler = $('.search-toggler'),
            ...
            role = $('.search-input').attr('data-logined-role'),
            base_url = $('.search-input').attr('data-base-url'),
        ...
        // Add container-xxl to twitter-typeahead
        ...
        if (searchInput.length) {
            ...
            // Search JSON
            if (role == 'Admin') {
                var searchJson = 'admin-search-vertical.json'; // For vertical layout
            } else if (role == 'Department Manager') {
                var searchJson = 'manager-search-vertical.json'; // For vertical layout
            } else {
                var searchJson = 'employee-search-vertical.json'; // For vertical layout
            }
